...
class ms2KanboardPackage
{
    ...
    /**
     * ms2KanboardPackage constructor.
     *
     * @param $core_path
     * @param array $config
     */
    ...
    protected function initialize()
    {
        ...
        $this->builder->registerNamespace($this->config['name_lower'], false, true, $this->config['namespace_path']);
...
$install = new ms2KanboardPackage(MODX_CORE_PATH, $config);
