...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('ms2kanboard', MODX_CORE_PATH . 'components/ms2kanboard/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/ms2kanboard/model/schema/ms2kanboard.mysql.schema.xml';
